...
<div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
      ...
      -->
        <div class="logo">
            <a href="http://www.cadeoproduto.com.br" class="simple-text logo-normal">
                Cadê O Produto
            </a>
        </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand">Cadê O Produto</a>
                </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <img style="max-height: 500px; Width: 100%" src="{{URL::asset('/imagens/cdproduto.png')}}">
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright float-right">
                    ...
                    <a href="https://www.cadeoproduto.com.br" target="_blank">Cadê O Produto</a>.
                </div>
            </div>
        </footer>
    </div>
